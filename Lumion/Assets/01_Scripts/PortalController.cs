...
public class PortalController : MonoBehaviour
{
    ...
    [SerializeField] private int indiceEscenaNivel2 = 3;
    ...
    private void TransportarANivel2()
    {
        if (usarNombreEscena)
        {
            if (!string.IsNullOrWhiteSpace(nombreEscenaNivel2) &&
            ...
            Debug.LogError(
                $"No se pudo cargar la escena por nombre '{nombreEscenaNivel2}'. Revisa Build Profiles.",
                this);
            yaTransporto = false;
            return;
        }
